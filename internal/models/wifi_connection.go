...
// NewWifiConnectionFromScanner creates a new Network instance from a budio scanner.
func NewWifiConnectionFromScanner(scanner *bufio.Scanner) (*WifiConnection, error) {
